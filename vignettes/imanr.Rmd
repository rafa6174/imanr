...
```{r show_data_template, eval = FALSE}
load("data20")
...
```{r using find_racial_complex, eval = FALSE}
...
```{r using impute_data, eval = FALSE}
# testing the function
imputed_data24 <- impute_data(data24, useParallel = FALSE)
imputed_data24
