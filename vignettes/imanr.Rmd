---
title: "iman: Identify racial complexes of native corn in Mexico"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Identify racial complexes of native corn in Mexico}
...
```{r using_find_racial_complex, eval=FALSE}
...
#>  [1] Dentados tropicales Dentados tropicales Dentados tropicales Dentados tropicales
#>  [5] Dentados tropicales Dentados tropicales Dentados tropicales Dentados tropicales
#>  [9] Cónico              Cónico              Cónico              Cónico             
#>  [13] Ocho hileras        Dentados tropicales Dentados tropicales Dentados tropicales
#>  [17] Dentados tropicales Cónico              Cónico              Cónico             
#>  [21] Cónico              Cónico              Cónico              Cónico             
#>  7 Levels: Chapalote Cónico Dentados tropicales Ocho hileras ... Tropicales tardíos
```

## Contact

-   Rafael Nieves-Alvarez ([email](nievesalvarez1618@gmail.com))
-   Arturo Sanchez-Porras ([email](sp.arturo@gmail.com))
-   Aline Romero-Natale ([email](ronatale@gmail.com))
-   Otilio Arturo Acevedo-Sandoval ([email](acevedo@uaeh.edu.mx))
